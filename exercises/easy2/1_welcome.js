...
// Note: can convert arrays using .join(). Can convert the Object values to an array with Object.values()


function greetings(array, object) {
  let stringName = array.join(' ');

  let objectValues = Object.values(object);

  let stringOccupation = objectValues.join(' ');

  return `Hello ${stringName}! Nice to have a ${stringOccupation} around.`
}
