...
function stringToInteger(string) {
  ...
  let arrayOfDigits = string.split('').map(element => DIGITS[element]);
  let value = 0;
...
console.log(stringToSignedInteger("-570") === -570); // logs true
console.log(stringToSignedInteger("+100") === 100); // logs true 
console.log(typeof stringToSignedInteger("4321")); // logs true
console.log(typeof stringToSignedInteger("-570")); // logs true
console.log(typeof stringToSignedInteger("+100")); // logs true