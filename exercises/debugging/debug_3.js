...
// random returns an array of words. dishName attempts to concatenate the arrays with a plus sign, you can't concatenate arrays. I say this coerces those to strings. so you have one big messy string for dish name. .join is then called on a string which you cannot do

// this can be fixed by concatenating the arrays togehter