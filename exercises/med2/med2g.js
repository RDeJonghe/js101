...
// iterate over array
// check i against i + 1 with greater than
// reassign if first element is greater than reassign it to i + 1, reassign i + 1 to i
// possibly do this with do while loop ... can stop when there aren't any that are greater than
