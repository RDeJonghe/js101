...
// algorithm (assuming word passed is lowercased)
// create a function that takes a word and paragraph variable
// create an uppervariable by taking the word and slicing and concating so the first char is upper
// split the array and map
// if any of the words matches the word or upper word var
// uperrcase them and concat ** before and after
// join and return
...
function searchWord(word, paragraph) {
  ...
  return paragraph.split(' ')
    .map(splitWord => {
      if (splitWord === word || splitWord === upperWord) {
