...
// create a first half, and second half variable to store the values to add together
// create a while loop, start at n - 1 and while greater than or equal to one
